...
<body>
	...
	<section class="newsletter">
		<div class="container">
			<h2>Dapatkan Inspirasi Setiap Minggu</h2>

			<p>
				Berlangganan newsletter kami untuk tips perjalanan eksklusif,
				penawaran hotel terbaik, dan panduan destinasi terbaru langsung
				ke email Anda.
			</p>
